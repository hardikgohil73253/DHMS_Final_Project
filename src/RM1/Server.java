...
import RM1.webcontroller.implementation.AppointmentManagement;
import log.Log;
        ...
        public ServerInstance(String serverID, String[] args) throws Exception {
            ...
            switch (serverID) {
                case "MTL":
                    serverName = "MONTREAL";
                    serverUdpPort = 1217;
                    internalUdpPort =1211;
                    break;
                case "QUE":
                    serverName = "QUEBEC";
                    serverUdpPort = 1218;
                    internalUdpPort = 1212;
                    break;
                case "SHE":
                    serverName = "SHERBROOKE";
                    serverUdpPort = 1219;
                    internalUdpPort =1213;
                    break;
            }
            try {
                System.out.println(serverName + " RM1 Server Started...");
                Log.serverLog(serverID, " RM1 Server Started...");
