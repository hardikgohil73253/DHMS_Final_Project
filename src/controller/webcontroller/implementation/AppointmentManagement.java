package controller.webcontroller.implementation;
...
@WebService(endpointInterface = "src.controller.webcontroller.webServiceInterface")

@SOAPBinding(style = SOAPBinding.Style.RPC)
public class AppointmentManagement implements webServiceInterface {
    ...
    public static final int MONTREAL_SERVER_INTERNAL_UDP_PORT = 8889;

    public static final int QUEBEC_SERVER_INTERNAL_UDP_PORT = 7778;

    public static final int SHERBROOKE_SERVER_INTERNAL_UDP_PORT = 6667;
