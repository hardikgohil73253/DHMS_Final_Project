...
import RM3.webcontroller.implementation.AppointmentManagement;
import log.Log;
...
public class Server3 {
    public static void main(String[] args) {
        ...
        executor.submit(new Server3.ServerInstanceRunnable("MTL", args));
        executor.submit(new Server3.ServerInstanceRunnable("QUE", args));
        executor.submit(new Server3.ServerInstanceRunnable("SHE", args));
        executor.shutdown();
    }
            ...
            try (DatagramSocket aSocket = new DatagramSocket(serverUdpPort)) {
                ...
                while (true) {
                    ...
                    if (function.equalsIgnoreCase("addMovie")) {
                        System.out.println("UDP request received in server " + function + " appointmentID: " + appointmentID + " appointmentType: " + appointmentType + " ...");
