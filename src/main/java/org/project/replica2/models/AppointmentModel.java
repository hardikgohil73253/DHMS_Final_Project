package org.project.replica2.models;
...
public class AppointmentModel {
    ...
    private VariableStore.APPOINTMENT_TYPE appointmentType; //Physician, Surgeon, Dental
    private String appointmentID; // MTLA101023
    private VariableStore.SERVERS appointmentServer; //MTL, SHE, QUE
    private String appointmentDate; //10/10/2024
    private VariableStore.APPOINTMENT_TIME appointmentTimeSlot; //M, A, E
