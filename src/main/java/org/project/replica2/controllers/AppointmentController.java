package org.project.replica2.controllers;

import org.project.replica2.interfaces.WebServiceInterface;
import org.project.replica2.models.AppointmentModel;
import org.project.replica2.models.ClientModel;
import org.project.replica2.Logger;
...
@WebService(endpointInterface = "org.project.replica2.interfaces.WebServiceInterface")
...
public class AppointmentController implements WebServiceInterface {
    ...
    public  String listAppointmentAvailability(String appointmentType) {
        ...
        if (currentServerID.equals(VariableStore.SERVERS.MTL.toString())) {
            firstServer = broadcastMessageToOtherServers(7035, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(VariableStore.SHERBROOKE_SOCKET_PORT2, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        } else if (currentServerID.equals(VariableStore.SERVERS.SHE.toString())) {
            firstServer = broadcastMessageToOtherServers(7035, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(VariableStore.MONTREAL_SOCKET_PORT2, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        } else {
            firstServer = broadcastMessageToOtherServers(VariableStore.MONTREAL_SOCKET_PORT2, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(VariableStore.SHERBROOKE_SOCKET_PORT2, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        }
    ...
    private String bookAppointmentForOtherCities(String patientID, String appointmentID,
        ...
        if (!checkWeeklySchedule(patientID, appointmentID.substring(4))) {
            String broadcasterResponse = broadcastMessageToOtherServers(
                    VariableStore.getSocketPortsForReplica2(AppointmentModel.detectAppointmentServer(appointmentID)), "bookAppointment",
    ...
    /**
     * Gets appointment schedule.
     *
     * @param patientID the patient id
     * @return the appointment schedule
     */
    @Override
                            ...
                            if (hashUserAppointment.containsKey(patientID)) {
                                if (hashUserAppointment.get(patientID).containsKey(appointmentType)) {
                                    ...
                                    String list = broadcastMessageToOtherServers(
                                            VariableStore.getSocketPortsForReplica2(
    ...
    /**
     * Remove appointment broadcaster string.
     *
     * @param oldAppointmentID the old appointment id
