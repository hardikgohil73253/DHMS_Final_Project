...
public class Logger {
    ...
    private static String getFileName(int logType, String ID) {
        final String serverPath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "Logs" + File.separator + "Replica2_Server";
        final String clientPath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "Logs" + File.separator + "Replica2_Client";
        String fileName = "";
