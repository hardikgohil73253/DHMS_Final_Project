package org.project.replica1.controllers;

import org.project.replica1.interfaces.WebServiceInterface;
import org.project.replica1.models.AppointmentModel;
import org.project.replica1.models.ClientModel;
import org.project.replica1.Logger;
...
@WebService(endpointInterface = "org.project.replica1.interfaces.WebServiceInterface")
...
public class AppointmentController implements WebServiceInterface {
    ...
    public  String listAppointmentAvailability(String appointmentType) {
        ...
        if (currentServerID.equals(VariableStore.SERVERS.MTL.toString())) {
            firstServer = broadcastMessageToOtherServers(8035, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(8034, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        } else if (currentServerID.equals(VariableStore.SERVERS.SHE.toString())) {
            firstServer = broadcastMessageToOtherServers(8035, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(8033, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        } else {
            firstServer = broadcastMessageToOtherServers(8033, "listAppointmentAvailability",
                    "null", appointmentType, "null");
            secondServer = broadcastMessageToOtherServers(8034, "listAppointmentAvailability",
                    "null", appointmentType, "null");
        }
    ...
    private String bookAppointmentForOtherCities(String patientID, String appointmentID,
        ...
        if (!checkWeeklySchedule(patientID, appointmentID.substring(4))) {
            String broadcasterResponse = broadcastMessageToOtherServers(
                    VariableStore.getSocketPortsForReplica1(AppointmentModel.detectAppointmentServer(appointmentID)), "bookAppointment",
                            ...
                            if (hashUserAppointment.containsKey(patientID)) {
                                if (hashUserAppointment.get(patientID).containsKey(appointmentType)) {
                                    ...
                                    String list = broadcastMessageToOtherServers(
                                            VariableStore.getSocketPortsForReplica1(
