...
public class Replica1 {
    ...
    private static void receive()  {
        ...
        try {
            ...
            System.out.println("RM1 UDP Server Started.");
    ...
    private static String requestToServers(Message input)  {
        ...
        try {
            ...
            URL montrealURL = new URL(url + 8077 + "/" + "montreal?wsdl");
            QName montrealQName = new QName("http://controllers.replica1.project.org/", "AppointmentControllerService");
            montrealWebService = Service.create(montrealURL, montrealQName);

            URL quebecURL = new URL(url + VariableStore.QUEBEC_SERVER_PORT1 + "/" + "quebec?wsdl");
            QName quebecQName = new QName("http://controllers.replica1.project.org/", "AppointmentControllerService");
            quebecWebService = Service.create(quebecURL, quebecQName);

            URL sherbrookURL = new URL(url + 8078 + "/" + "sherbrook?wsdl");
            QName sherbrookQName = new QName("http://controllers.replica1.project.org/", "AppointmentControllerService");
    ...
    private static int serverPort(String input) {
        ...
        if (branch.equalsIgnoreCase("que"))
            portNumber = VariableStore.QUEBEC_SERVER_PORT1;
