...
import org.project.replica1.controllers.AppointmentController;
...
public class Server {
    ...
    private void configServer(VariableStore.SERVERS serverLocation) {
        ...
        if (serverLocation.equals(VariableStore.SERVERS.MTL)) {
            this.serverPort = 8077;
            this.serverBroadCastPort = 8033;
            serverEndpoint = url+this.serverPort+"/"+"montreal";
        } else if (serverLocation.equals(VariableStore.SERVERS.QUE)) {
            this.serverPort = VariableStore.QUEBEC_SERVER_PORT1;
            this.serverBroadCastPort = 8035;
            serverEndpoint = url+this.serverPort+"/"+"quebec";
        } else {
            this.serverPort = 8078;
            this.serverBroadCastPort = 8034;
