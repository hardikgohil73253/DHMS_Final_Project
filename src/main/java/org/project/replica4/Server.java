...
import org.project.replica4.controllers.AppointmentController;
...
public class Server {
    ...
    private void configServer(VariableStore.SERVERS serverLocation) {
        ...
        if (serverLocation.equals(VariableStore.SERVERS.MTL)) {
            this.serverPort = VariableStore.MONTREAL_SERVER_PORT4;
            this.serverBroadCastPort = VariableStore.MONTREAL_SOCKET_PORT4;
            serverEndpoint = url+this.serverPort+"/"+"montreal";
        } else if (serverLocation.equals(VariableStore.SERVERS.QUE)) {
            this.serverPort = VariableStore.QUEBEC_SERVER_PORT4;
            this.serverBroadCastPort = VariableStore.QUEBEC_SOCKET_PORT4;
            serverEndpoint = url+this.serverPort+"/"+"quebec";
        } else {
            this.serverPort = VariableStore.SHERBROOKE_SERVER_PORT4;
            this.serverBroadCastPort = VariableStore.SHERBROOKE_SOCKET_PORT4;
