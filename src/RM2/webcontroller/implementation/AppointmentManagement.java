package RM2.webcontroller.implementation;

import Model.AppointmentModel;
import Model.ClientModel;
import RM2.webcontroller.webInterface;
import log.Log;
...
@WebService(endpointInterface = "src.RM2.webcontroller.webInterface")
...
public class AppointmentManagement implements webInterface {
    ...
    public static final int MONTREAL_SERVER_PORT = 2221;
    public static final int QUEBEC_SERVER_PORT = 2222;
    public static final int SHERBROOKE_SERVER_PORT = 2223;
