...
import RM2.webcontroller.implementation.AppointmentManagement;
import log.Log;
        ...
        public ServerInstance(String serverID, String[] args) throws Exception {
            ...
            switch (serverID) {
                case "MTL":
                    serverName = "MONTREAL";
                    serverUdpPort =2217 ;
                    internalUdpPort = 2211;
                    break;
                case "QUE":
                    serverName = "QUEBEC";
                    serverUdpPort = 2218;
                    internalUdpPort = 2212;
                    break;
                case "SHE":
                    serverName = "SHERBROOKE";
                    serverUdpPort = 2219;
                    internalUdpPort = 2213;
                    break;
            }
            try {
                System.out.println(serverName + " RM2 Server Started...");
                Log.serverLog(serverID, " RM2 Server Started...");
